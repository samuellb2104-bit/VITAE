...
Project developed by a two-person team. My role covered the development of the graphical interface with Swing, the backend logic, and the design and implementation of the SQL Server database.
